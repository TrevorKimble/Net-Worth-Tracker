...
import { BarChart3, Plus, ArrowLeft, TrendingUp, RefreshCw } from "lucide-react"
...
export default function Solo401kPortfolioPage() {
  ...
  const handleAddAsset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success('Asset added to Solo 401k successfully!')
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
          ...
          <Card>
            ...
            <CardContent>
              <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>Add New Solo 401k Asset</DialogTitle>
                    <DialogDescription>
                      Add a new asset to your Solo 401k Trust portfolio
                    </DialogDescription>
                  </DialogHeader>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: any) => {
                          let updatedAsset = { ...newAsset, type: value }
        ...
        <Card>
          <CardHeader>
            <CardTitle>Solo 401k Assets</CardTitle>
          ...
          <CardContent>
            {assets.length === 0 ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No Solo 401k assets yet</h3>
                <p className="text-gray-600 mb-4">Start by adding your first Solo 401k investment</p>
                <Button onClick={() => setAddDialogOpen(true)}>
                  <Plus className="h-4 w-4 mr-2" />
                  Add Your First Solo 401k Asset
                </Button>
              </div>
            ) : (
